...
<html lang="en" class="h-full" >
    ...
    <body>
        <div class=" bg-black w-full min-h-screen text-slate-800 relative py-4">
            <x-flash-message />
            <div class="grid col-span-9 mx-auto gap-2 sm:gap-4 md:gap-6 lg:gap-10 xl:gap-14 rounded-lg p-6 my-10 px-2">
                <div class="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow-xl shadow-slate-800 antialiased">
                    <h1 class="text-4xl font-medium">Reset password</h1>
                    <p class="text-slate-500">Fill up the form to reset the password</p>

                    <form action="/forgot-password" method="POST" class="my-10">
                        @csrf
